...
******sql******/
// IotDeviceModelReadAttr 设备类型只读属性定义表
type IotDeviceModelReadAttr struct {
	ID            int64  `gorm:"column:id;type:bigint(19)"`                   // ID 主键
	DeviceModelID int64  `gorm:"column:device_type_id;type:bigint(19)"`       // 设备类型ID-外键 设备类型ID-外键
...
type IotDevice struct {
	...
	DeviceModelID int64  `gorm:"column:device_type_id;type:bigint(20);not null"` // 设备类型ID-外键 设备类型ID-外键
...
type IotDeviceEvent struct {
	...
	DeviceModelEventID int64     `gorm:"column:device_type_event_id;type:bigint(19);not null"` // 设备类型事件定义ID-外键 设备类型事件定义ID-外键
...
type IotDeviceInvariantAttr struct {
	...
	DeviceModelInvariantAttrID string `gorm:"column:device_type_invariant_attr_id;type:varchar(32);not null"` // 固定属性ID 固定属性ID
...
******sql******/
// IotDeviceModel 物联网设备类型表
type IotDeviceModel struct {
	ID              int64  `gorm:"primary_key;column:id;type:bigint(19);not null"`    // 主键 分布式唯一ID
	DeviceModelUId  string `gorm:"column:device_type_uid;type:varchar(128);not null"` // 设备类型UID
	DeviceModelName string `gorm:"column:device_type_name;type:varchar(512)"`         // 设备类型名称
}
...
******sql******/
// IotDeviceModelConfigAttr 设备类型配置属性定义表
type IotDeviceModelConfigAttr struct {
	ID            int64  `gorm:"column:id;type:bigint(19)"`                   // ID 主键
	DeviceModelID int64  `gorm:"column:device_type_id;type:bigint(19)"`       // 设备类型ID-外键 设备类型ID-外键
...
******sql******/
// IotDeviceModelFunc 设备类型功能函数定义表
type IotDeviceModelFunc struct {
	ID            int64  `gorm:"column:id;type:bigint(19)"`                  // ID 主键
	DeviceModelID int64  `gorm:"column:device_type_id;type:bigint(19)"`      // 设备类型ID-外键 设备类型ID-外键
...
type IotDeviceConfigAttr struct {
	ID                      int64  `gorm:"primary_key;column:id;type:bigint(19);not null"`              // ID 主键
	DeviceID                int64  `gorm:"column:device_id;type:bigint(19);not null"`                   // 设备ID-外键 设备ID-外键
	DeviceModelConfigAttrID string `gorm:"column:device_type_config_attr_id;type:varchar(32);not null"` // 配置属性ID 配置属性ID
...
******sql******/
// IotDeviceModelEvent 设备类型事件定义表
type IotDeviceModelEvent struct {
	ID            int64  `gorm:"primary_key;column:id;type:bigint(19);not null"` // ID 主键
	DeviceModelID int64  `gorm:"column:device_type_id;type:bigint(19);not null"` // 设备类型ID-外键 设备类型ID-外键
...
******sql******/
// IotDeviceModelInvariantAttr 设备类型固定属性定义表
type IotDeviceModelInvariantAttr struct {
	ID            int64  `gorm:"column:id;type:bigint(19)"`               // ID 主键
	DeviceModelID int64  `gorm:"column:device_type_id;type:bigint(19)"`   // 设备类型ID-外键 设备类型ID-外键
