...
const (
	...
	PATH_DEVICE_F_UPDATE = utils.PATH_IOT_DEVICE_SINGLE + PATH_DEVICE_F + utils.PATH_UPDATE
	PATH_DEVICE_F_EXEC   = utils.PATH_IOT_DEVICE_SINGLE + PATH_DEVICE_F + utils.PATH_EXEC
)
