...
const (
	...
	PATH_DEVICE_P_UPDATE = utils.PATH_IOT_DEVICE_SINGLE + PATH_DEVICE_P + utils.PATH_UPDATE
	PATH_DEVICE_P_QUERY  = utils.PATH_IOT_DEVICE_SINGLE + PATH_DEVICE_P + utils.PATH_QUERY
)
